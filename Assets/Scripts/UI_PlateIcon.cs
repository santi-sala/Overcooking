...
public class UI_PlateIcon : MonoBehaviour
{
    ...
    private void UpdateVisual()
    {
        ...
        foreach (SO_KitchenObjects kitchenObjectSO in _plateKitchenObject.GetKitchenObjectSOList())
        {
            Transform iconTransform = Instantiate(_iconTemplate, transform);
            iconTransform.gameObject.SetActive(true);
            iconTransform.GetComponent<UI_PlateIconSingle>().SetKitchenObjectSO(kitchenObjectSO);
        }
    }
}
